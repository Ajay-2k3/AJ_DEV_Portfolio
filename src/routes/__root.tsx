...
const SITE_URL = "https://ajaydev.vercel.app";
...
const jsonLd = JSON.stringify({
  ...
  knowsAbout: ["React.js", "Node.js", "TypeScript", "PostgreSQL", "Next.js", "Full Stack Development"],
});
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Full Stack Engineer from Chennai building production-grade systems with React.js, Node.js, TypeScript, and PostgreSQL. Currently seeking full-stack roles." },
      ...
      { property: "og:site_name", content: "Ajay S Portfolio" },
      // Twitter Card
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Ajay S — Full Stack Software Engineer" },
      { name: "twitter:description", content: "Full Stack Engineer · React · Node.js · TypeScript · Chennai, India" },
